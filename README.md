...
```
The example:
integrates the nonlinear system,
evaluates the conservation error,
solves the analytical control configuration,
compares numerical and analytical results,
computes activation and crossover times,
generates the reference figures.
...
```
The analysis script:
reads the stored parameter sweep,
computes descriptive statistics,
checks missing characteristic times,
identifies fastest and slowest solutions,
compares activation and crossover times,
analyses reservoir depletion,
compares solutions with the analytical primary-limited benchmark,
aggregates behaviour by `k_B`, `K`, and `n`,
generates exploratory figures.
